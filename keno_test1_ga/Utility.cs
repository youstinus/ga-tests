...
namespace keno_test1_ga
{
    public class Utility
    {
        public static void ReadFile(List<Game> games)
        {
            try
            {
                var read = new StreamReader("..//..//..//data/keno.txt");
        ...
        public static void Serialize(List<Game> games)
        {
            ...
            var fs = new FileStream("..//..//..//data//keno.dat", FileMode.Create);
        ...
        public static IEnumerable<Game> Deserialize()
        {
            ...
            var fs = new FileStream("..//..//..//data//keno.dat", FileMode.Open);
            try
            {
                var formatter = new BinaryFormatter();
